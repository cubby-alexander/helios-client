      ...
      <div style={styles.container}>
        ...
        <div style={styles.heroContent}>
          <p style={styles.detailText}>
            Unlock the potential of satellite technology and expand your business reach with Helios,
            the premier digital marketplace for commercial satellite services.
          </p>
